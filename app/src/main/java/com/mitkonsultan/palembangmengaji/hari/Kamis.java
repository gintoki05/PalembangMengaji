...
import com.mitkonsultan.palembangmengaji.hariviewadapter.KamisViewAdapter;
import com.mitkonsultan.palembangmengaji.menu.AlarmKamis;
...
public class Kamis extends AppCompatActivity {
    ...
    private List<KamisDataAdapter> lostList = new ArrayList<>();
    private RecyclerView recyclerView;
    private KamisViewAdapter mAdapter;
    private ArrayList<KamisDataAdapter> posts;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Glide.with(getApplicationContext()).load("http://palembangmengaji.forkismapalembang.com/gambar/hari/kamis.png")
                .thumbnail(0.5f)
    ...
    private void initUi(){
        recyclerView = (RecyclerView) findViewById(R.id.recyclerViewkamis);
        mAdapter = new KamisViewAdapter((ArrayList<KamisDataAdapter>) lostList);
    ...
    private void loadLost(){
        String url2 = "http://palembangmengaji.forkismapalembang.com/api.php?hari=kamis";
            ...
            public void onResponse(JSONArray response) {
                ...
                try {
                    for (int i = 0; i <response.length() ; i++) {
                        ...
                        KamisDataAdapter lostItem = new KamisDataAdapter(
    ...
    public boolean onOptionsItemSelected (MenuItem item){
        ...
        if (id == R.id.action_alarm) {
            Intent intent = new Intent(this, AlarmKamis.class);
