...
import com.mitkonsultan.palembangmengaji.hariviewadapter.SabtuViewAdapter;
import com.mitkonsultan.palembangmengaji.menu.AlarmSabtu;
...
public class Sabtu extends AppCompatActivity {
    ...
    private List<SabtuDataAdapter> lostList = new ArrayList<>();
    private RecyclerView recyclerView;
    private SabtuViewAdapter mAdapter;
    private ArrayList<SabtuDataAdapter> posts;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Glide.with(getApplicationContext()).load("http://palembangmengaji.forkismapalembang.com/gambar/hari/sabtu.png")
                .thumbnail(0.5f)
    ...
    private void initUi(){
        recyclerView = (RecyclerView) findViewById(R.id.recyclerViewsabtu);
        mAdapter = new SabtuViewAdapter((ArrayList<SabtuDataAdapter>) lostList);
    ...
    private void loadLost(){
        String url2 = "http://palembangmengaji.forkismapalembang.com/api.php?hari=sabtu";
            ...
            public void onResponse(JSONArray response) {
                ...
                try {
                    for (int i = 0; i <response.length() ; i++) {
                        ...
                        SabtuDataAdapter lostItem = new SabtuDataAdapter(
    ...
    public boolean onOptionsItemSelected (MenuItem item){
        ...
        if (id == R.id.action_alarm) {
            Intent intent = new Intent(this, AlarmSabtu.class);
