...
import com.mitkonsultan.palembangmengaji.hariviewadapter.RabuViewAdapter;
import com.mitkonsultan.palembangmengaji.menu.AlarmRabu;
...
public class Rabu extends AppCompatActivity {
    ...
    private List<RabuDataAdapter> lostList = new ArrayList<>();
    private RecyclerView recyclerView;
    private RabuViewAdapter mAdapter;
    private ArrayList<RabuDataAdapter> posts;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Glide.with(getApplicationContext()).load("http://palembangmengaji.forkismapalembang.com/gambar/hari/rabu.png")
                .thumbnail(0.5f)
    ...
    private void initUi(){
        recyclerView = (RecyclerView) findViewById(R.id.recyclerViewrabu);
        mAdapter = new RabuViewAdapter((ArrayList<RabuDataAdapter>) lostList);
    ...
    private void loadLost(){
        String url2 = "http://palembangmengaji.forkismapalembang.com/api.php?hari=rabu";
            ...
            public void onResponse(JSONArray response) {
                ...
                try {
                    for (int i = 0; i <response.length() ; i++) {
                        ...
                        RabuDataAdapter lostItem = new RabuDataAdapter(
    ...
    public boolean onOptionsItemSelected (MenuItem item){
        ...
        if (id == R.id.action_alarm) {
            Intent intent = new Intent(this, AlarmRabu.class);
