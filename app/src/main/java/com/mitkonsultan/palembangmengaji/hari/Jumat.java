...
import com.mitkonsultan.palembangmengaji.hariviewadapter.JumatViewAdapter;
import com.mitkonsultan.palembangmengaji.menu.AlarmJumat;
...
public class Jumat extends AppCompatActivity {
    ...
    private List<JumatDataAdapter> lostList = new ArrayList<>();
    private RecyclerView recyclerView;
    private JumatViewAdapter mAdapter;
    private ArrayList<JumatDataAdapter> posts;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Glide.with(getApplicationContext()).load("http://palembangmengaji.forkismapalembang.com/gambar/hari/jumat.png")
                .thumbnail(0.5f)
    ...
    private void initUi(){
        recyclerView = (RecyclerView) findViewById(R.id.recyclerViewjumat);
        mAdapter = new JumatViewAdapter((ArrayList<JumatDataAdapter>) lostList);
    ...
    private void loadLost(){
        String url2 = "http://palembangmengaji.forkismapalembang.com/api.php?hari=jumat";
            ...
            public void onResponse(JSONArray response) {
                ...
                try {
                    for (int i = 0; i <response.length() ; i++) {
                        ...
                        JumatDataAdapter lostItem = new JumatDataAdapter(
    ...
    public boolean onOptionsItemSelected (MenuItem item){
        ...
        if (id == R.id.action_alarm) {
            Intent intent = new Intent(this, AlarmJumat.class);
