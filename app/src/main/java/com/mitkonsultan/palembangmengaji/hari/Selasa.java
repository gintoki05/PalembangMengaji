...
import com.mitkonsultan.palembangmengaji.hariviewadapter.SelasaViewAdapter;
...
public class Selasa extends AppCompatActivity {
    ...
    private List<SelasaDataAdapter> lostList = new ArrayList<>();
    private RecyclerView recyclerView;
    private SelasaViewAdapter mAdapter;
    private ArrayList<SelasaDataAdapter> posts;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Glide.with(getApplicationContext()).load("http://palembangmengaji.forkismapalembang.com/gambar/hari/selasa.png")
                .thumbnail(0.5f)
    ...
    private void initUi(){
        recyclerView = (RecyclerView) findViewById(R.id.recyclerViewselasa);
        mAdapter = new SelasaViewAdapter((ArrayList<SelasaDataAdapter>) lostList);
    ...
    private void loadLost(){
        String url2 = "http://palembangmengaji.forkismapalembang.com/api.php?hari=selasa";
            ...
            public void onResponse(JSONArray response) {
                ...
                try {
                    for (int i = 0; i <response.length() ; i++) {
                        ...
                        SelasaDataAdapter lostItem = new SelasaDataAdapter(
    ...
    public boolean onOptionsItemSelected (MenuItem item){
        ...
        if (id == R.id.action_alarm) {
            Intent intent = new Intent(this, AlarmSelasa.class);
